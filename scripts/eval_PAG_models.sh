...
CUDA_VISIBLE_DEVICES=7 uv run python scripts/run_eval.py \
    ...
    --retrieval-k 1 \
    --tasks PAG_personalreddit_ood_test PAG_personalreddit_random_test PAG_EC_ood_test PAG_EC_random_test
    # PAG_lamp_movie_ood_test PAG_lamp_movie_random_test PAG_lamp_news_cat_ood_test PAG_lamp_news_cat_random_test PAG_lamp_citation_ood_test PAG_lamp_citation_random_test PAG_longlamp_abstract_generation_ood_test PAG_longlamp_abstract_generation_random_test \
