...
CUDA_VISIBLE_DEVICES=1 uv run python scripts/run_eval.py \
    --model-dir Qwen/Qwen2.5-7B-Instruct \
    --save-to-base-model-dir \
    --max-context-length 32768 \
    --tasks all_history_lamp_citation_random_test all_history_lamp_movie_random_test all_history_lamp_news_cat_random_test all_history_lamp_news_headline_random_test all_history_lamp_product_random_test all_history_lamp_scholarly_title_random_test all_history_lamp_tweet_random_test all_history_longlamp_abstract_generation_random_test all_history_longlamp_product_review_random_test all_history_longlamp_topic_writing_random_test \
    all_history_lamp_citation_ood_test all_history_lamp_movie_ood_test all_history_lamp_news_cat_ood_test all_history_lamp_news_headline_ood_test all_history_lamp_product_ood_test all_history_lamp_scholarly_title_ood_test all_history_lamp_tweet_ood_test all_history_longlamp_abstract_generation_ood_test all_history_longlamp_product_review_ood_test all_history_longlamp_topic_writing_ood_test
